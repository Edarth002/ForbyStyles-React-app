...
export const Hero = ({ targetDate }) => {
  //866584931eb58aaf118b9de73193d17d-us21
  //ebcd97fc2f
    ...
    <div className="hero-section ">
      <div className="text-white">
        ...
        <div className="Hero text-white p-5 text-center">
          <h1 className="md:text-5xl text-3xl md:w-1/3 mx-auto md:mt-0 mt-10 mb-3">
            A New Era in Fashion Awaits
          </h1>
          <p>
            Counting down to the grand reveal of Forby Styles. Unleash your
            style in...
          </p>
        </div>
        <div className="md:px-20 mx-auto">
          <div className="border border-yellow-400 md:min-w-[40rem] md:w-4/5 w-[95%] md:mx-auto md:p-10 p-5 flex items-center mx-3">
          ...
          {/* <div className="flex md:flex-row flex-col md:w-[70%] w-[80%] mx-auto mt-10 md:items-start">
            <div className="flex flex-col items-center w-full">
              <input
                ...
                className="md:min-w-[20rem] border outline-none bg-transparent border-yellow-400 rounded-full py-2 px-4 md:w-[95%] w-full"
              />
            ...
            <a
              href="/"
              className="cursor-pointer hover:bg-black md:mt-0 mt-6 hover:text-yellow-400 md:min-w-[13rem] text-center bg-yellow-400 text-black rounded-full py-2 px-5 hover:scale-110"
